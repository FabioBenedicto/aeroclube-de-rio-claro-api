...
const receivables_repository_1 = require("./repository/receivables.repository");
...
exports.ReceivablesModule = ReceivablesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            receivables_service_1.ReceivablesService,
            {
                provide: receivables_repository_interface_1.RECEIVABLES_REPOSITORY,
                useClass: receivables_repository_1.ReceivablesRepository,
            },
        ],
    })
], ReceivablesModule);
