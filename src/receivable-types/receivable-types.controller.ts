...
export class ReceivableTypesController {
  constructor(private readonly service: ReceivableTypesService) {}
  ...
  create(@Body() dto: CreateReceivableTypeDto) {
  ...
  update(
    ...
    @Body() dto: UpdateReceivableTypeDto,
  ) {
